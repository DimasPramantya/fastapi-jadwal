...
class MataKuliah(Base):
    ...
    kd_mata_kuliah: Mapped[str] = mapped_column(String(14), nullable=True)
    ...
    semester: Mapped[str] = mapped_column(String(8), nullable=True)
    ...
    nama_prodi_en: Mapped[str] = mapped_column(String(20), nullable=True)
